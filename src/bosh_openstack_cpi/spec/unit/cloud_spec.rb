...
describe Bosh::OpenStackCloud::Cloud do
  ...
  describe :new do
    ...
    before {
      ...
      expect(Fog::OpenStack::Image::V1).to_not receive(:new)
      expect(Fog::OpenStack::Volume::V1).to_not receive(:new)
  ...
  describe :update_agent_settings do
    ...
    before { allow(Fog::OpenStack::Image::V1).to receive(:new).and_return(image) }
